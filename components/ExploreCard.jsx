...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick}) => (
  ...
  className={`relative ${
    ...
    'lg:flex-[0.5] flex-[2]'
  } flex items-center justify-center min-w-[170px] h-[7-px] transition-[flex] duration-[0.7s] ease-out-flex cursor-pointer`}
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        ...
        </div><p className="font-normal text-[16px] leading-[20px] text-white uppercase">Enter the Metaverse</p>
